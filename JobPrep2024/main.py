...
from _217_Contains_Duplicate import Solution as Solution217
from _238_Product_of_Array_Except_Self import Solution as Solution238
...
def execute238():
    ...
    nums1 = [2,6,4,5,2]
    nums2 = [2,6,0,5,3]
    print(nums1, sol.productExceptSelf(nums1))
    print(nums2, sol.productExceptSelf(nums2))
